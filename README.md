...
Funcționalități principale:
  - Gestionarea cererilor: administratorul poate vizualiza toate cererile aflate în așteptare, trimise de către profesori,la alocarea unui ghid, sistemul taxează automat doar tariful de serviciu pe grup, biletul ghidului fiind gratuit.
  ...
  - Filtrare și Raportare: poate afișa toate grupurile aprobate si membrii acestora(sortați automat după vârstă) filtrate după o anumită dată calendaristică.
  ...
  - Statistici și Management Locație: poate vizualiza veniturile totale ale muzeului, numărul total de muzee din rețea și poate actualiza adresa fizică.
  - Administrare Expoziții: administratorul poate modifica titlul expozițiilor temporare, poate actualiza prețurile acestora sau adăuga exponate noi în timpul rulării.


2. Utilizator (Profesorul)
Conectarea: accesul se face pe baza numelui, prenumelui și a unei parole generate automat (în formatul Nume.Prenume). Dacă profesorul se conectează pentru prima dată, aplicația îi creează automat un cont nou, cerându-i date precum vârsta, experiența și școala la care predă.Sistemul validează datele și emite un avertisment dacă profilul profesorului este încadrat ca minor.
...
Funcționalități principale:
  ...
  - Editare Profil și Reprogramare: profesorul își poate actualiza în timp real informațiile personale (nume, prenume, email, vârstă) și, dacă are o cerere aprobată sau în așteptare, poate solicita direct reprogramarea vizitei la o altă dată calendaristică validă. 
